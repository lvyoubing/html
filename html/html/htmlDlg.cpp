...
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Control(pDX, browser, browser);
}
...
BEGIN_MESSAGE_MAP(ChtmlDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &ChtmlDlg::OnBnClickedButton1)
	ON_BN_CLICKED(read, &ChtmlDlg::OnBnClickedread)
END_MESSAGE_MAP()
